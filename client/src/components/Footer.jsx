                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <ul className="space-y-1 text-xs">
                            <li><Link href="/#about" className="hover:text-blue-400 transition-colors">About Ministry</Link></li>
                    ...
                    <div className="space-y-2">
                        ...
                        <ul className="space-y-1 text-xs">
                            <li><a href="#" className="hover:text-blue-400 transition-colors">FAQ section</a></li>
                            <li><a href="#" className="hover:text-blue-400 transition-colors">Submission Guidelines</a></li>
                            <li><a href="#" className="hover:text-blue-400 transition-colors">Proposal Templates</a></li>
                            <li><a href="#" className="hover:text-blue-400 transition-colors">Brochures</a></li>
                    ...
                    <div className="space-y-2">
                        ...
                        <ul className="space-y-1 text-xs">
                            <li><Link href="#" className="hover:text-blue-400 transition-colors">Company profile</Link></li>
                            <li><Link href="#" className="hover:text-blue-400 transition-colors">Our Team</Link></li>
                            <li><Link href="#" className="hover:text-blue-400 transition-colors">Careers</Link></li>
                            <li><Link href="#" className="hover:text-blue-400 transition-colors">Environmental policy</Link></li>
                            <li><Link href="#" className="hover:text-blue-400 transition-colors">Privacy policy</Link></li>
                            <li><Link href="#" className="hover:text-blue-400 transition-colors">Terms and conditions</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <ul className="space-y-1 text-xs">
                            <li><a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:text-blue-400 transition-colors">Twitter</a></li>
                            <li><a href="https://facebook.com" target="_blank" rel="noreferrer" className="hover:text-blue-400 transition-colors">Facebook</a></li>
                            ...
                            <li><a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-blue-400 transition-colors">LinkedIn</a></li>
                            <li><a href="#" className="hover:text-blue-400 transition-colors">Official Blog</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-xs space-y-1">
                            ...
                            <a href="https://goo.gl/maps/example" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline block">View Map →</a>
