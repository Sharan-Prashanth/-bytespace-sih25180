...
import {
  ...
  CommandItem,
  CommandList,
} from '@/components/ui (plate files)/command';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@/components/ui (plate files)/dialog';
import { Input } from '@/components/ui (plate files)/input';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
import { aiChatPlugin } from '@/components/ProposalEditor/editor (plate files)/plugins/ai-kit';
                        ...
                        <CommandGroup>
                          {models.map((m) => (
                            <CommandItem
                              ...
                              <Check
                                className={cn('mr-2 size-4', tempModel.value === m.value
                                  ? 'opacity-100'
                                  : 'opacity-0')} />
                              <code>{m.label}</code>
                            </CommandItem>
