/**
 * FormITab - Form I Editor
 * This component contains Form I content for the research proposal
 * Converted from TipTap to Plate.js format
 */

export const formITabConfig = {
  id: 'formi',
  label: 'Form I',
  description: 'Project Proposal for S&T Grant',
  type: 'editor',
};

export const formIDefaultContent = [
  {
    type: 'h1',
    align: 'center',
...
export default {
  config: formITabConfig,
  defaultContent: formIDefaultContent,
};
