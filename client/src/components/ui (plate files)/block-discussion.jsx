...
import { Button } from '@/components/ui (plate files)/button';
import {
  Popover,
  PopoverAnchor,
  PopoverContent,
...
import { discussionPlugin } from '@/components/ProposalEditor/editor (plate files)/plugins/discussion-kit';
  ...
  return (
    <div className="flex w-full justify-between">
      <Popover
        ...
        <PopoverContent
          className="max-h-[min(50dvh,calc(-24px+var(--radix-popper-available-height)))] w-[380px] max-w-[calc(100vw-24px)] min-w-[130px] overflow-y-auto p-0 data-[state=closed]:opacity-0 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 border-slate-200 dark:border-slate-700"
        ...
        {totalCount > 0 && (
          <div className="relative ml-2 select-none">
            <PopoverTrigger asChild>
              <Button
                variant="ghost"
                className="flex h-7 gap-1.5 px-2 py-1 text-orange-600 bg-orange-50 hover:bg-orange-100 hover:text-orange-700 border border-orange-200 data-[active=true]:bg-orange-100 data-[active=true]:border-orange-300 rounded-md shadow-sm"
                data-active={open}
