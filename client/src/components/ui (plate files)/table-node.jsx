...
import { Popover, PopoverContent } from '@/components/ui (plate files)/popover';
...
export function TableCellElement({
  ...
  return (
    <PlateElement
      ...
      as={isHeader ? 'th' : 'td'}
      className={cn(
        'h-full overflow-visible border-none p-0 align-top',
        // Use CSS variable for background to support theming
      ...
      style={
        {
          ...
          width: element.width || width || 'auto'
        }
      }
      attributes={{
        ...props.attributes,
